...
OutputBaseFilename=keepnote-0.5.3
Compression=lzma
...
[Files]
Source: dist\keepnote-0.5.3.win\*; DestDir: {app}; Flags: ignoreversion recursesubdirs createallsubdirs
