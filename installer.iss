...
OutputBaseFilename=keepnote-0.5.2
Compression=lzma
...
[Files]
Source: dist\keepnote-0.5.2.win\*; DestDir: {app}; Flags: ignoreversion recursesubdirs createallsubdirs
